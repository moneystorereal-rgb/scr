...
<script runat="server">
	...
	protected override void OnPreRender(EventArgs e)
	{
		...
		if (this.wizard.ActiveStepIndex == 1)
			this.wizard.FindControl("passwordBox").Focus();
...
#pragma warning restore 618
	...
	void OnWizardFinishButtonClick(object sender, EventArgs e) => this.Page.RegisterAsyncTask(async () =>
	{
		try
		{
			...
			WebExtensions.RegisterPageStartupScript(this, "SC.dialog.showModalActivityAndReload('Save', {0:js}, {1:js});", true, ServerConstants.HostPageUrl);
		}
		catch (Exception ex)
		{
				...
				<asp:WizardStep runat="server" Title="<%$ WebResources:SetupWizard.SecurityTitle %>">
					...
					<dl>
						...
						<dt>
							...
							<asp:CompareValidator runat="server" ControlToValidate="passwordBox" ControlToCompare="verifyPasswordBox" Text="*" Display="Dynamic" CssClass="Failure" />
						</dt>
						<dd>
